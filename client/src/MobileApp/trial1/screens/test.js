...
import { View, Text, StyleSheet, Image, ImageBackground, TouchableHighlight, TouchableOpacity, Button } from "react-native";
  ...
  render() {
    ...
    return (
      <View style={styles.root}>
        ...
        <TouchableOpacity onPress= {async() => {navigate("First")}}>
          <Image
            style={styles.button}
