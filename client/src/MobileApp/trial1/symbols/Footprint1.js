...
export default class Footprint1 extends Component {
    ...
    return (
      <View style={[styles.root, this.props.style]}>
        <View style={styles.foot1}>
          <View style={styles.lFoot5}>
            <Svg
              viewBox="0 0 23.21 57.51"
              preserveAspectRatio="none"
              style={styles.footDarkL5}
            >
              <Defs>
          ...
          <View style={styles.rFoot5}>
            <Svg
              viewBox="0 0 23.21 57.51"
              preserveAspectRatio="none"
              style={styles.footDarkerR5}
            >
              <Defs>
